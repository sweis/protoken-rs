...
fn assert_claims_vector(name: &str, claims: &Claims) {
...
#[test]
fn test_vector_claims_minimal() {
    assert_claims_vector(
        "claims_minimal",
        &Claims {
...
#[test]
fn test_vector_claims_max_expiry() {
    assert_claims_vector(
        "claims_max_expiry",
        &Claims {
            expires_at: u64::MAX,
...
#[test]
fn test_vector_deserialize_claims_from_stored_base64() {
    let vectors = load_vectors();
